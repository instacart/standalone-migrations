...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<activerecord>, ["< 6.1.0", ">= 4.2.7"])
      s.add_runtime_dependency(%q<railties>, ["< 6.1.0", ">= 4.2.7"])
    else
      s.add_dependency(%q<rake>, [">= 10.0"])
      s.add_dependency(%q<activerecord>, ["< 6.1.0", ">= 4.2.7"])
      s.add_dependency(%q<railties>, ["< 6.1.0", ">= 4.2.7"])
    end
  else
    s.add_dependency(%q<rake>, [">= 10.0"])
    s.add_dependency(%q<activerecord>, ["< 6.1.0", ">= 4.2.7"])
